...
function SkuInSpu({
  ...
  const onDelete = useCallback(() => {
    messageFeedback.showAlertWithCancel('确认删除?', '', () => {
      dispatch({
        ...
        payload: { shopIndex, spuIndex, id: sku.id }
      })
    })
  }, [shopIndex, spuIndex, sku.id, dispatch])
  ...
  const onNumChange = useCallback(
    (num: number) => {
      ...
      dispatch({
        ...
        payload: { shopIndex, spuIndex, id: sku.id, num, groupNum }
      })
    },
    [sku.groupNum, sku.id, sku.num, dispatch, shopIndex, spuIndex]
  )
  ...
  const checkSku = useCallback(() => {
    ...
    dispatch({
      ...
      payload: { spuIndex, shopIndex, id: sku.id, checked: !sku.checked }
    })
  }, [sku, spuIndex, shopIndex, dispatch, disabled])
